...
class MovieActorList extends Component {
    ...
    render() {
        ...
        const firstTwentyCast = actors.slice(0, 10)
        return (
                ...
                <div className="movie-cast uk-animation-fade delay: 200">
                    <div className="d-flex justify-content-between align-align-items-center">
                        ...
                        <div className="custom-control custom-switch pr-5 info">
                            <input type="checkbox" className="custom-control-input info" id="show-all" onClick={this.showAllCastView} checked={this.state.showAll} />
                            <label className="custom-control-label" htmlFor="show-all">Show all</label>
                        </div>
                    </div>
